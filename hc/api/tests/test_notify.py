...
class NotifyTestCase(BaseTestCase):
    ...
    @patch("hc.api.transports.requests.request")
    def test_connection_errors(self, mock_post):
        self._setup_data("webhook", "http://example")
        mock_post.return_value.status_code = 500

        self.channel.notify(self.check)
        notifications = Notification.objects.get()
        self.assertEqual(notifications.error, "Received status code 500")
    ...
    def test_connection_timeout(self, mock_get):
        ...
        self.channel.notify(self.check)
        notifications = Notification.objects.get()
        self.assertEqual(notifications.error, "Connection timed out")
    ...
    def test_connection_error(self, mock_get):
        ...
        self.channel.notify(self.check)
        notifications = Notification.objects.get()
        self.assertEqual(notifications.error, "Connection failed")
